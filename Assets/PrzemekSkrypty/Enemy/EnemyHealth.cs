...
public class EnemyHealth : MonoBehaviour
{
    ...
    //    // NOWE: Show damage number (opcjonalne - zrobimy p�niej)
    ...
    private void Die(int killerPhotonViewID)
    {
        ...
        // Sprawdzamy czy to my zabili�my (killerPhotonViewID != -1 oznacza �e trafi�a go wie�a/pocisk)
        // Wa�ne: Musimy si� upewni�, �e zaliczamy to lokalnemu graczowi tylko je�li to JEGO wie�a zabi�a,
        // LUB w trybie single/co-op po prostu zaliczamy.

        // Wersja prosta (zalicza �mier� ka�demu na mapie - dobre dla Co-op):
    ...
    {
        // Placeholder - zaimplementujemy p�niej z VFX system
